...
## Overview
The Google Calendar integration allows patients and doctors to automatically sync their CareFlow appointments to their Google Calendar. Events are created, updated, and deleted automatically through OAuth 2.0.
...
5. Verify redirect back to CareFlow with success message
6. Book an appointment with symptoms
7. Open Google Calendar - verify event appears
8. Cancel appointment in CareFlow
...
- `apps/web/components/careflow-app.tsx` - Settings UI
