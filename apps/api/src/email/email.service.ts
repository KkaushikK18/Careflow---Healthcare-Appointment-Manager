...
export class ResendProvider implements IEmailProvider {
  ...
  constructor(private configService: ConfigService) {
    ...
    this.emailFrom = this.configService.get<string>('emailFrom') || 'CareFlow <noreply@careflow.demo>';
...
export class EmailService {
  ...
  async sendBookingConfirmation(
    ...
    const subject = '✓ Appointment Confirmed - CareFlow';
  ...
  async sendRescheduleEmail(
    ...
    const subject = '📅 Appointment Rescheduled - CareFlow';
  ...
  async sendLeaveConflictEmail(
    ...
    const subject = 'Appointment Requires Rescheduling - CareFlow';
  ...
  async sendMedicationReminder(
    ...
    const subject = '💊 Medication Reminder - CareFlow';
  ...
  async sendPostVisitSummaryEmail(
    ...
    const subject = '📄 Visit Summary Available - CareFlow';
          ...
          <tr>
            <td style="padding: 32px;">
              ...
              <p style="margin: 24px 0 0; color: #6d7b7d; font-size: 14px; line-height: 1.5;">
                You'll receive a reminder 24 hours before your appointment. If you need to reschedule or cancel, please log in to your CareFlow account.
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 24px 32px; background-color: #f6f7f4; border-radius: 0 0 12px 12px;">
              <p style="margin: 0; color: #6d7b7d; font-size: 12px; line-height: 1.5; text-align: center;">
                <strong>CareFlow</strong> · Healthcare, coordinated.
                <br>
        ...
        <table role="presentation" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
          ...
          <tr>
            <td style="padding: 32px;">
              ...
              <p style="margin: 24px 0 0; color: #6d7b7d; font-size: 14px; line-height: 1.5;">
                Please arrive 10 minutes early. If you can't make it, please cancel or reschedule through your CareFlow account.
              </p>
            </td>
          </tr>
        ...
        <table role="presentation" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px;">
          <tr>
            <td style="padding: 32px;">
              ...
              <p style="margin: 24px 0 0; color: #6d7b7d; font-size: 14px; line-height: 1.5;">
                If you'd like to reschedule, please log in to your CareFlow account to book a new appointment.
              </p>
            </td>
          </tr>
            ...
            <td style="padding: 32px;">
              ...
              <div style="background-color: #f8ecd9; border-left: 4px solid #b27622; border-radius: 8px; padding: 20px; margin: 24px 0;">
                <p style="margin: 0; color: #172427; font-size: 14px; line-height: 1.5;">
                  Please log in to your CareFlow account to select a new date and time that works for you. We apologize for any inconvenience this may cause.
                </p>
              </div>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 32px;">
              ...
              <div style="background-color: #dceee8; border-radius: 8px; padding: 20px; margin: 24px 0;">
                <p style="margin: 0; color: #172427; font-size: 14px; line-height: 1.5;">
                  Log in to your CareFlow account to view your personalized visit summary, medications, and next steps.
                </p>
              </div>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 32px;">
              ...
              <p style="margin: 16px 0 0; color: #6d7b7d; font-size: 14px; line-height: 1.5;">
                If you have any questions or need to make further changes, please log in to your CareFlow account.
              </p>
            </td>
          </tr>
