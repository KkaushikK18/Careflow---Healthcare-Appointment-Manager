      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="reveal mx-auto max-w-2xl text-center">
          ...
          <p className="mt-5 text-pretty text-lg text-white/60">
            CareFlow is designed with layered security — from authentication
        ...
        <div className="reveal reveal-delay-3 mx-auto mt-10 flex max-w-2xl items-start gap-3 rounded-xl border border-white/10 bg-white/[0.03] p-4">
          ...
          <p className="text-sm text-white/55">
            CareFlow uses industry-standard security practices. It is a
            student project and does not hold formal healthcare compliance
            certifications.
          </p>
        </div>
      </div>
